...
This folder contains unit tests for the models and utilities implemented in
`quant-trading-lab`.
...
- Compares Heston Monte Carlo prices to Black–Scholes prices in the limit
  of “almost constant variance”
...
- Verifies that the grid-search calibration approximately recovers
  known SABR parameters on a synthetic smile
